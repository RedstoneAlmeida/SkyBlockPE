...
class BiomeSubCommand extends SubCommand{
	private $biomes = ["PLAINS" => Biome::PLAINS,"DESERT" => Biome::DESERT,"MOUNTAINS" => Biome::MOUNTAINS,"FOREST" => Biome::FOREST,"TAIGA" => Biome::TAIGA,"SWAMP" => Biome::SWAMP,"OCEAN" => Biome::OCEAN,"RIVER" => Biome::RIVER,"ICE_PLAINS" => Biome::ICE_PLAINS,
			"SMALL_MOUNTAINS" => Biome::SMALL_MOUNTAINS,"BIRCH_FOREST" => Biome::BIRCH_FOREST];
	...
	public function getDescription(){
		return "Changes your island's biome";
	}
